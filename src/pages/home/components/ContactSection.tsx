          ...
          <div className="space-y-6 text-center">
            ...
            <div className="pt-2 flex justify-center">
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full px-7 py-3 text-[0.75rem] sm:text-sm md:text-base font-semibold tracking-[0.22em] uppercase bg-black/75 backdrop-blur-xl border border-white/40 text-[#FDF7F2] shadow-[0_16px_40px_rgba(0,0,0,0.45)] hover:bg-black/80 hover:shadow-[0_20px_50px_rgba(0,0,0,0.6)] transition-all duration-200 whitespace-nowrap cursor-pointer"
                style={{ fontFamily: 'Inter, sans-serif' }}
              >
          ...
          <div className="bg-black/60 backdrop-blur-xl rounded-3xl shadow-[0_18px_60px_rgba(0,0,0,0.55)] border border-white/15 px-6 py-7 md:px-7 md:py-8">
            <form className="grid gap-6 md:grid-cols-2 text-left" onSubmit={handleSubmit}>
              ...
              <div className="md:col-span-2 flex justify-end">
                <button
                  type="submit"
                  className="px-8 py-3 rounded-full font-semibold text-[0.75rem] sm:text-sm md:text-base shadow-[0_16px_40px_rgba(0,0,0,0.45)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.6)] transition-all duration-300 border border-white/40 bg-black/60 backdrop-blur-xl tracking-[0.22em] uppercase text-[#FDF7F2]"
                  style={{ fontFamily: 'Inter, sans-serif' }}
                >
