...
function TestimonialCard({
  ...
  return (
    <article
      className={`flex flex-col h-full rounded-3xl bg-black/60 border border-white/15 shadow-none px-6 py-6 md:px-7 md:py-7 hover:-translate-y-1 hover:shadow-none transition-all duration-300 ${className}`}
    >
      <div className="flex items-center gap-4 mb-4">
        <div className="w-11 h-11 rounded-full overflow-hidden bg-white/12 border border-white/35 flex items-center justify-center text-sm font-semibold text-[#FDF7F2]">
          {testimonial.image ? (
            <img
