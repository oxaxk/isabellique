      ...
      <div className="container mx-auto px-4">
            ...
            >
              {services.map((svc) => (
                <div key={svc.title} className="shrink-0 w-[85%] md:w-[45%] lg:w-[38%] snap-center">
                  <div className="bg-black/60 backdrop-blur-xl border border-white/10 rounded-2xl overflow-hidden shadow-[0_18px_45px_rgba(0,0,0,0.55)] hover:shadow-[0_24px_60px_rgba(0,0,0,0.7)] transition-all duration-300 h-[480px] md:h-[460px] lg:h-[480px] flex flex-col">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4 mt-16">
          <Button
            ...
            size="lg"
            className="text-[0.75rem] sm:text-sm md:text-base px-8 py-3.5 rounded-full bg-black/75 backdrop-blur-xl text-[#FDF7F2] border border-white/40 shadow-[0_16px_40px_rgba(0,0,0,0.45)] tracking-[0.22em] uppercase hover:bg-black/80 hover:shadow-[0_20px_50px_rgba(0,0,0,0.6)]"
          >
